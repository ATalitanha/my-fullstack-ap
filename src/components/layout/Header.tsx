    ...
    <header className="sticky top-0 z-50 backdrop-blur supports-backdrop-filter:bg-white/60 dark:supports-backdrop-filter:bg-gray-900/60 border-b border-white/30 dark:border-gray-800/30">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/"
            className="font-extrabold text-[clamp(1rem,2vw,1.25rem)] tracking-tight text-gray-900 dark:text-white"
          >
            Modern Web
          </Link>
        </div>
          ...
          {user ? (
            <DropdownMenu.Root>
              <DropdownMenu.Trigger asChild>
                <button className="inline-flex items-center gap-2 rounded-full px-3 py-2 bg-linear-to-r from-blue-600 to-indigo-600 text-white text-sm">
              ...
              <DropdownMenu.Content className="min-w-[180px] rounded-xl bg-white dark:bg-gray-800 border border-gray-200/80 dark:border-gray-700/80 shadow-xl p-2">
                ...
                <DropdownMenu.Item asChild>
                  <button
                    onClick={logout}
                    className="w-full px-3 py-2 rounded-lg text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 inline-flex items-center gap-2"
                  >
            ...
            <div className="flex items-center gap-2">
              <Link
                href="/login"
                className="px-3 py-2 rounded-xl bg-white/80 dark:bg-gray-800/80 border border-white/40 dark:border-gray-700/40 text-gray-700 dark:text-gray-200"
              >
                ورود
              </Link>
              <Link
                href="/signup"
                className="px-3 py-2 rounded-xl bg-linear-to-r from-blue-600 to-indigo-600 text-white"
              >
                ثبت‌نام
              </Link>
            </div>
