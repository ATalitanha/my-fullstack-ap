import { createCipheriv, createDecipheriv, createCipheriv as createCipherGCM, createDecipheriv as createDecipherGCM, randomBytes } from "crypto";
...
// ----- Email: AES-CBC (IV ثابت) برای deterministic encryption -----
const IV_EMAIL = Buffer.alloc(16, 0); // IV ثابت برای ایمیل
