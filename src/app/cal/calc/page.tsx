...
export default function Calculator() {
  ...
  return (
    <>
      ...
      {/* بخش اصلی ماشین‌حساب */}
      <div dir='ltr' className={`relative min-h-screen pt-16 transition-colors duration-700 z-10 ${theme} bg-linear-to-br from-slate-100 via-slate-200 to-slate-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900`}>
            ...
            >
              ...
              <div className="flex justify-center gap-3">
                ...
                <motion.button
                  ...
                  className="px-5 py-2 rounded-lg text-white transition shadow-md bg-linear-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-7001"
                >
                  پاک کردن
                </motion.button>
              </div>
