...
const mockNotes = [
  { id: '1', title: 'Test Note 1', content: 'Content 1', createdAt: new Date().toISOString() },
  { id: '2', title: 'Test Note 2', content: 'Content 2', createdAt: new Date().toISOString() },
];
...
describe('NotesPage', () => {
  ...
  it('should create a new note', async () => {
    ...
    mockFetch.mockResolvedValueOnce({
      ok: true,
      json: () => Promise.resolve({ note: { id: '3', title: 'New Note', content: 'New Content', createdAt: new Date().toISOString() } }),
    });
    mockFetch.mockResolvedValueOnce({
        ok: true,
        json: () => Promise.resolve({ notes: [{ id: '3', title: 'New Note', content: 'New Content', createdAt: new Date().toISOString() }] }),
      });
