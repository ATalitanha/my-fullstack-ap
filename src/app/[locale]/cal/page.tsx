...
export default function Cal() {
  const t = useTranslations('CalPage');
  ...
  const calculatorTools = [
    {
      href: "/cal/calc",
      title: t('simpleCalculatorTitle'),
      description: t('simpleCalculatorDescription'),
      icon: Calculator,
    ...
    {
      href: "/cal/advanc-cal",
      title: t('advancedCalculatorTitle'),
      description: t('advancedCalculatorDescription'),
      icon: Zap,
